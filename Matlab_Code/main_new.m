...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
%AGGIUGNERE GRAFICO DEL RESIDUAL
%USARE LA ROBA SPARSA
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fprintf('Result of the exact method (from point 1):  (%2.15f, %2.15f) \n', xk_1(1), xk_1(2));
fprintf('Value of f. in xmin using the exact method (from point 1): %2.30f\n', fk_1);
fprintf('Result of the exact method (from point 2):  (%2.15f, %2.15f) \n', xk_2(1), xk_2(2));
fprintf('Value of f. in xmin using the exact methos (from point 2): %2.30f\n', fk_2);

fprintf('Result of the centered-centered method (from point 1):  (%2.15f, %2.15f) \n', xk_1_cc(1),xk_1_cc(2));
fprintf('Value of f. in xmin using the centered-centered method (from point 1):  %2.30f\n', fk_1_cc);
fprintf('Result of the centered-centered method (from point 2):  (%2.15f, %2.15f) \n', xk_2_cc(1), xk_2_cc(2));
fprintf('Value of f. in xmin using the centered-centered method (from point 2): %2.30f\n ', fk_2_cc);

fprintf('Result of matrix the free implementation (from point 1): (%2.15f, %2.15f) \n', xk_1_MF(1), xk_1_MF(2));
fprintf('Value of f. in xmin using the matrix free implementation (from point 1):  %2.30f\n', fk_1_MF);
fprintf('Result of matrix the free implementation (from point 1):  (%2.15f, %2.15f) \n', xk_2_MF(1), xk_2_MF(2));
fprintf('Value of f. in xmin using the matrix free implementation (from point 2):  %2.30f\n', fk_2_MF);
